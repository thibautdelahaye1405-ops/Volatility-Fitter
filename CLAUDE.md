...
- Tests:    cd backend ; ..\.venv\Scripts\python -m pytest tests -q   (921 passed, 1 skipped as of 2026-07-06, incl. 7 perf rails; +1 live test via $env:VOLFIT_LIVE="1"; perf-only: -m perf -s)
