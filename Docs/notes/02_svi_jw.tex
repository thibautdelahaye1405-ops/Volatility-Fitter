...
Gatheral--Jacquier conditions give sufficient parameter-space inequalities (e.g.
$b(1+|\rho|)\le 4/(... )$-type bounds and the requirement that the minimum
variance be non-negative); the calibrator enforces the two that bite in practice.
