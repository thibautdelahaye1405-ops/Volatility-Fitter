...
(\cref{prop:tail}).  Every cheap no-arbitrage
...
(\cref{sec:calib})\\
Tail-clean & $\wmin\ge0$ and $\max(\betL,\betR)<2$ (strict) & the two soft
coded screens, fenced at $\beta_{\max}=\svimomleecap$; zero on a clean slice\\
