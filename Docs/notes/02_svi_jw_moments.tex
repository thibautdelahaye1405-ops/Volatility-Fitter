...
was burning its budget.  The default stays \texttt{"raw"} until the
frozen-regime benchmark adjudicates the flip --- the same evidence bar the
LQD logistic chart cleared before becoming a default.
