...
\texttt{graphPropagationMode} & \texttt{smooth\_field} & propagation-operator
seed (\texttt{precision\_messages} / \texttt{hybrid} opt-ins; the layered
dynamic-harmonic pipeline is a per-request opt-in) & 14\\
