...
comparison: the analytic and finite-difference fits reach an \emph{identical}
optimum (cost differs at the $10^{-16}$ level) while the analytic Jacobian is
$1.4$--$1.7\times$ faster across $N=6\ldots12$ on this benchmark, with both paths
converging in a handful of iterations.
...
$b(1+\rho)=0.0364$ (right): the Lee slopes agree to two--three digits even though
nothing imposed it --- they emerge from the fitted endpoint basis. The exact ATM
...
instead of $P+1$ finite-difference rebuilds, exact (optimum unchanged to
$10^{-16}$), measured $1.4$--$1.7\times$ end-to-end here and structurally more on
heavier configurations. Gated to the var-swap/prior-free configuration.
