...
($\priwingmo\%$ at $k=-0.30$). The prior-persisted fit keeps the ATM at the
\emph{market} level (\priatmpersist\%, \emph{not} damped toward the prior's
\priatmprior\%) because the gate is zero where the quotes are dense, while holding
