...
objects a desk actually persists --- and locates the one place
where the price is misquoted.
...
their smallest entry, which is the dead-leg rule in one phrase.  In
the electrical picture of \cref{sec:infcombine}, a basket wires its
legs' resistances in series: the total resistance is the sum, and
one broken leg --- a near-infinite resistor --- cuts the whole
circuit.
...
The support proxy has one failure mode, and it binds exactly here.
...
proxy is the cost of gating before fitting.
