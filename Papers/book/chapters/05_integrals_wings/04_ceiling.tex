...
book the ratios simply converge).  The claim is that no admissible
smile --- no smile that prices a positive law with mean one --- can
have either slope above $2$.
...
steep prices calls that refuse to become worthless, contradicting
\eqref{eq:vscalldies}.
...
is slow and honesty requires showing it.  The three regimes of
...
the last quote --- and shows that it, too, refuses to select.
