...
wings; two-curve (calendar) checks confined to common quote support
(\cref{eq:calrows}).\\
\addlinespace
...
the wing contract that completes the integral, disclosed in a table
...
every expiry.  Part~II starts by earning them.
