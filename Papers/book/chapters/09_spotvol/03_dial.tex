...
We know the bookkeeping; now build the rule.  The guiding idea is
...
promised extra volatility that the at-the-money reading actually
collects.
...
and its second-order honesty is exactly this one curvature term.
