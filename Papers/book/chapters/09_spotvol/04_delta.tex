\section{The price of the choice: delta}
\label{sec:ssrdelta}

We have a one-dial family of transports, and a claim from
\cref{sec:ssrmissing} to make good: the dial is a hedge ratio.  This
...
(hundredths).  The three curves tell one story with three endings:
