\section{Two coordinate systems, one discipline}
\label{sec:ssrsigns}

Before any rule can be written down, one piece of bookkeeping must be
...
like a plausible smile.  The discipline is to derive each sign the way
