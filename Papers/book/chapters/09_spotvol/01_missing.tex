...
the readings on the market's clock.  Part~I turned such observations into
...
\Cref{fig:ssrquestion} draws the predicament before any rule is built.  In
...
the chapter builds the choices properly: first the sign conventions
(\cref{sec:ssrsigns}), then the one-parameter family
of rules and its dial (\cref{sec:ssrdial}), then the stakes in
