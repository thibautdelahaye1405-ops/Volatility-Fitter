...
stated exceptions on the two shortest expiries of
...
check: halving to quartering the time step moves the bent field's
...
consume the fitted model's published wing, as discussed in
\cref{sec:ssrboard}.
