...
bp apart.  One note of precision on those two numbers: the first-order
...
one regime that derives its answer, reappears one level deeper: the
...
One boundary closes the section.  The frozen field is itself a
