...
read once, and the examples compound deliberately: the two December
smiles of the frozen data thread the book end to end --- one fitted,
probed, transported and thinned from Part~I through Part~III, the
other withheld in the final chapter and reconstructed, by a solver
that never saw it, from its neighbours.  The
