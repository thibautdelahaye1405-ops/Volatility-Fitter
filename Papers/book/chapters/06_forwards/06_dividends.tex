...
dividends are accounted for, and Chapter~7's early-exercise machinery
runs on a dividend model as its fuel.
...
structure of $F$ were the whole story, the choice would be cosmetic.

It is not, and panel~(b) shows the honest discriminator: what happens
to the forward when \emph{spot moves}.  Differentiate each convention
...
forward outruns spot: the dividends claim a fixed slice, and the
