...
For a single stock or an ETF, neither is
...
construction is either measured from the data or chosen and stated.
...
Before the general method, solve the smallest possible case by
