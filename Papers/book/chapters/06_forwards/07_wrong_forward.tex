...
The chapter opened by claiming that a small forward error is a large
smile error.  Every tool needed to prove that claim is now on the
...
\Cref{fig:fwdskew} draws both halves of the story on the running
