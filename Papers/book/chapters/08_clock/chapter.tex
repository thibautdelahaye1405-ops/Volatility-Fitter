...
%      and state its honest limits: dates inside an interval are
...
has quietly set it equal to the calendar.  This chapter earns the
distinction.  A scheduled event --- an earnings report, a macro print
...
earns its keep twice: dense term-structure curves must be interpolated
