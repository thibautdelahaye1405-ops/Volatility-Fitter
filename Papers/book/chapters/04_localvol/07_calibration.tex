...
\caption{The tangent system, seen and checked.  (a)~Sensitivity of the
...
collected its variance.  In panel~(b), the check: every analytic
...
The optimization itself is then standard: a
