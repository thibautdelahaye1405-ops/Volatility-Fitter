...
low-dimensional and interpretable, but does not turn extrapolation into
observation.  Calibration must therefore report the tail coordinates together
with the convention that selected them.
