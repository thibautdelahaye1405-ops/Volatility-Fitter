...
SYSTEM_PROMPT = (
    ...
    "3. Cite every card you rely on by its title, as a bullet list at the end, "
    "one card per bullet: \"- see: <card title>\" (a plain hyphen bullet on its "
    "own line, never several citations on one line).\n"
