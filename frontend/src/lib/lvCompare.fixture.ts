...
export function lvCompareFixture(overrides: Partial<LvCompareResponse> = {}): LvCompareResponse {
  return {
    ...
    xNodes: X_NODES,
    localVolTwin: TWIN,
    tNodesFine: [0, 0.05, 0.1, 0.3, 0.5],
    xNodesFine: [0.8, 0.85, 0.9, 0.95, 1.0, 1.05, 1.1],
    localVolTwinFine: [
      [0.22, 0.21, 0.2, 0.19, 0.18, 0.185, 0.19],
      [0.23, 0.215, 0.205, 0.195, 0.185, 0.19, 0.195],
      [0.24, 0.225, 0.21, 0.2, 0.19, 0.195, 0.2],
      [0.25, 0.235, 0.22, 0.21, 0.2, 0.205, 0.21],
      [0.26, 0.245, 0.23, 0.22, 0.21, 0.215, 0.22],
    ],
