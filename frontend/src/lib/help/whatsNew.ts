...
export const WHATS_NEW: WhatsNewEntry[] = [
  {
    ...
    items: [
      ...
      "Every relation is now an arrow drawn on the canvas, informer → receiver: thickness reads its confidence, colour its β (cool below 1, slate at 1, warm above, rose negative). Click an arrow to edit it, the Connect tool or a Shift-drag from node to node draws a new one, Delete removes the selected relation, a ticker's pod label collapses it, and Focus clears the side panes for a big universe.",
